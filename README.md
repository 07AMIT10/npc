...
├── internal/
│   ├── api/                 # LLM integration & orchestration
│   ├── llm/                 # Provider adapters & load balancing
│   ├── game/                # World, teams, zones
│   ├── challenge/           # Puzzle system
│   └── observability/       # Tracing & audit logs
├── web/
...
### Problem
Currently: 4 NPCs × 15 decisions/min = **60 API calls/minute**
...
## 🎨 Phase 2: Visual Polish (React Migration)
...
src/
├── components/
│   ├── GameCanvas/          # Canvas + particle system
│   ├── Sidebar/             # React components
│   ├── Header/              # Animated scoreboard
...
// User clicks Reset → cancel() → saves API tokens
```
